...
def index():
	...
	nice_datetime_today = datetime_today.strftime("%b %d, %Y")

	games = get_games(datetime_today)

	return render_template("index.html", title="Daily Scores", games=games, nice_datetime_today=nice_datetime_today)
"""Gets lists of games for the day
